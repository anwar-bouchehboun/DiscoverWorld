...
<body>
    ...
    <nav>
        <div class="flex flex-wrap items-center justify-between bg-emerald-50 md:p-0">
            <div class="px-4 w-[20%] "><a href="{{ url('/') }}"> <img src="/storage/DiscoverWorld-removebg-preview.png" width="60px" alt="logo"></a></div>
            <div class="p-3 md:hidden">
                <img id="menu-button"
                    class="h-6 transition-opacity duration-500 ease-in-out cursor-pointer hover:opacity-[0.5]"
                    src="/storage/Hamburger_icon.svg.png" alt="list icon">
            </div>
